...
describe("LiveSync-owned translation catalogue", () => {
    ...
    it("serves English from its own catalogue whatever language is selected", () => {
        // This fork ships English only; the language plumbing stays so that
        // Commonlib's host boundary is satisfied, but there is nothing to pick.
        setLang("es");
